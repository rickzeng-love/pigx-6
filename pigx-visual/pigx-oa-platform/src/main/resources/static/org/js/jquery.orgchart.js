  ...
  OrgChart.prototype = {
    ...
    createNode: function (data) {
      ...
      if (opts.nodeTemplate) {
       ...
       $nodeDiv.append('<div class="title" id="' + data[opts.nodeId] + '">' + data[opts.nodeContent] + '</div>')
        ...
        //alert(data[opts.nodeId].substring(1,1));
         if(data[opts.nodeId].substring(0,1)=='C'){
           $nodeDiv.append('<div class="content">'+
             '<div class="contbm">'+
             '<div class="fzr"><p>负责人：</p><span>'+data[opts.nodeName]+'</span></div>'+
             '<div class="renshu"><p>人数：</p><span>'+data[opts.nodeRS]+'</span></p></div>'+
             '</div>'+
           ...
           $nodeDiv.append('<div class="content">'+
             ...
             '<div class="fzr"><p>负责人：</p><span>'+data[opts.nodeName]+'</span></div>'+
             '<div class="renshu"><p>人数：</p><span>'+data[opts.nodeRS]+'</span></p></div>'+
             '<div class="bianz"><p>编制：</p><span>'+data[opts.nodeBZ]+'</span></p></div>'+
             '</div>'+
             '<div class="contimg"><img src="http://39.99.202.116:9000'+data[opts.nodeImg]+'"/></div>'+
             '</div>');
         }
