...
(function (factory) {
  ...
  OrgChart.prototype = {
    ...
    createNode: function (data) {
      ...
      $nodeDiv.append('<a href="javascript:void(0)" class="icon aiconadd" data-id="'+data[opts.nodeId]+'" onclick="addTu(this)"><i class="iconfont ante--add"></i></a>');
      $nodeDiv.append('<a href="javascript:void(0)" class="icon aiconedit" data-id="'+data[opts.nodeId]+'" onclick="editTu(this)"><i class="iconfont ante--devise"></i></a>');
      $nodeDiv.append('<a href="javascript:void(0)" class="icon aicondet" data-id="'+data[opts.nodeId]+'" onclick="deleteTu(this)"><i class="iconfont ante--delete"></i></a>');
